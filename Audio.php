...
readonly class Audio
{
	...
	public int $duration;//	Integer	Duration of the audio in seconds as defined by sender
	public string|null $performer;//	String	Optional. Performer of the audio as defined by sender or by audio tags
	public string|null $title;//	String	Optional. Title of the audio as defined by sender or by audio tags
	...
	public PhotoSize|null $thumbnail;//	PhotoSize	Optional. Thumbnail of the album cover to which the music file belongs
