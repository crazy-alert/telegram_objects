...
readonly class ChatMemberAdministrator extends ChatMember
{
	...
	public string $status;//	String	The member's status in the chat, always “administrator”
	public User $user;//	User	Information about the user
	public bool $can_be_edited;//	Boolean	True, if the bot is allowed to edit administrator privileges of that user
	...
	public string|null $custom_title;//	String	Optional. Custom title for this user
