...
readonly class Animation
{
	...
	public PhotoSize|null $thumbnail;//	PhotoSize	Optional. Animation thumbnail as defined by sender
	public string|null $file_name;//	String	Optional. Original animation filename as defined by sender
